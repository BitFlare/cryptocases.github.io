...
var config = {
    ...
    recaptcha_sitekey: '6Le_aQwUAAAAADuWbEEenttK6hgPDJva37C20fB0', // <----- EDIT ME!
    redirect_uri: 'http://flareus.ga',
            ...
            if (caset === 'vl') {
                ...
                var params = {
                    ...
                    'payouts': [{
                        "from": 0,
                        "to": 2104533975,
                        "value": wagerSatoshis * 2.0
                    }, {
                        "from": 2126008811,
                        "to": 4080218930,
                        "value": wagerSatoshis * 0
                    }, {
                        "from": 4080218930,
                        "to": 4294967296,
                        "value": wagerSatoshis * 0.3
                    }]
                };
                MoneyPot.placeCustomBet(params, {
                    success: function(bet) {
                        ...
                        if (bet.profit == wagerSatoshis * 0.3 - wagerSatoshis) {
                            result = 15;
                        }
                        if (bet.profit == 0 - wagerSatoshis) {
                            result = 20;
                        }
                        if (bet.profit == wagerSatoshis * 2.0 - wagerSatoshis) {
                            result = 25;
                        }
            ...
            if (caset == 'l') {
                ...
                MoneyPot.placeCustomBet(params, {
                    success: function(bet) {
                        ...
                        if (bet.profit == wagerSatoshis * 3.0 - wagerSatoshis) {
                            result = 25;
                        }
                        console.log(bet.profit)
                        var $cardList = $('.cardList').first(),
            ...
            if (caset == 'm') { //42520176
                ...
                MoneyPot.placeCustomBet(params, {
                    success: function(bet) {
                        ...
                        if (bet.profit == wagerSatoshis * 5.0 - wagerSatoshis) {
                            result = 25;
                        }
                        console.log(bet.profit)
                        var $cardList = $('.cardList').first(),
            ...
            if (caset == 'h') {
                ...
                MoneyPot.placeCustomBet(params, {
                    success: function(bet) {
                        ...
                        if (bet.profit == wagerSatoshis * 10.0 - wagerSatoshis) {
                            result = 25;
                        }
                        console.log(bet.profit)
                        var $cardList = $('.cardList').first(),
            ...
            if (caset == 'vh') {
                ...
                MoneyPot.placeCustomBet(params, {
                    success: function(bet) {
                        ...
                        if (bet.profit == wagerSatoshis * 100.0 - wagerSatoshis) {
                            result = 25;
                        }
                        console.log(bet.profit)
                        var $cardList = $('.cardList').first(),
