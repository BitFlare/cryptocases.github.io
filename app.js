...
var BetBox = React.createClass({
  ...
  _makeBet: function(caset) {
    var self = this;

    console.assert(caset === 'vl' || caset === 'l' || caset === 'm' || caset === 'h' || caset === 'vh');

    return function(e) {
      console.log('Placing bet...');
	var tags1 = document.getElementsByName("card1");
    ...
    tags1[i].innerHTML = '0X';
	tags2[i].innerHTML = '1.3X';
	tags3[i].innerHTML = '2X';
}
		var params = {
		'client_seed': 0,
		'hash': hash,
		'wager': wagerSatoshis,
		'payouts': [
    { "from": 0, "to": 2104533975, "value": wagerSatoshis * 2.0 },
    { "from": 2126008811, "to": 4080218930, "value": wagerSatoshis * 0 },	
	{ "from": 4080218930, "to": 4294967296, "value": wagerSatoshis * 0.3 }		
		]
      };
MoneyPot.placeCustomBet(params, {
        success: function(bet) {
          console.log('Successfully placed bet:', bet);
          // Append to bet list
          ...
          Dispatcher.sendAction('UPDATE_USER', {
            balance: worldStore.state.user.balance + bet.profit
		  					  ...
		  					  if(bet.profit == wagerSatoshis * 0.3 - wagerSatoshis) { result = 15; }
if(bet.profit == 0 - wagerSatoshis) { result = 20; }
if(bet.profit == wagerSatoshis * 2.0 - wagerSatoshis) { result = 25; }
...
var $cardList 	= $('.cardList').first(), 
    ...
    width 		= 100, 
    randomize 	= false, 
    distance 	= result * width,
    selected = 2;
;

/*var $cardList 	= document.getElementsByClassName('cardList')[0], 
...
;*/
    ...
    spin(distance, 5000);
	  ...
	  if(caset == 'l') {
		  ...
		  document.getElementById("value1").innerHTML = '1.3X'; //2
		  document.getElementById("value2").innerHTML = '3X'; //3
		  document.getElementById("value3").innerHTML = '0X'; //1

		  		  for (var i = 0; i < 50; i++) {
				if(tags1[i] === undefined || tags2[i] === undefined || tags3[i] === undefined) continue;
    tags1[i].innerHTML = '0X';
	tags2[i].innerHTML = '1.3X';
	tags3[i].innerHTML = '3X';
}
		var params = {
		'client_seed': 0,
		'hash': hash,
		'wager': wagerSatoshis,
		'payouts': [
    { "from": 0, "to": 1288490188, "value": wagerSatoshis * 3.0 }, 
    { "from": 1288490188, "to": 1975684955, "value": wagerSatoshis * 0.3 },	
	{ "from": 1975684955, "to": 4294967296, "value": wagerSatoshis * 0 }		
		]
      };
MoneyPot.placeCustomBet(params, {
        success: function(bet) {
		  ...
		  var result;
		  					  if(bet.profit == wagerSatoshis * 0.3 - wagerSatoshis) { result = 15; }
if(bet.profit == 0 - wagerSatoshis) { result = 20; }
if(bet.profit == wagerSatoshis * 3.0 - wagerSatoshis) { result = 25; }
console.log(bet.profit)
var $cardList 	= $('.cardList').first(), 
    $cards 		= $('.card'),
    $speed 		= 5000, 
...
;*/
    ...
    spin(distance, 5000);
	  ...
	  if(caset == 'm') { //42520176
		  document.getElementById("value1").innerHTML = '1.3X'; //2
		  document.getElementById("value2").innerHTML = '5X'; //3
		  document.getElementById("value3").innerHTML = '0X'; //1
	...
	tags3[i].innerHTML = '5X';
		...
		'wager': wagerSatoshis,
		'payouts': [
    { "from": 0, "to": 850403525, "value": wagerSatoshis * 5.0 }, 
    { "from": 850403525, "to": 861140943, "value": wagerSatoshis * 0.3 },	
	{ "from": 861140943, "to": 4294967296, "value": wagerSatoshis * 0 }		
		]
      };
MoneyPot.placeCustomBet(params, {
        success: function(bet) {
		  ...
		  var result;
		  					  if(bet.profit == wagerSatoshis * 0.3 - wagerSatoshis) { result = 15; }
if(bet.profit == 0 - wagerSatoshis) { result = 20; }
if(bet.profit == wagerSatoshis * 5.0 - wagerSatoshis) { result = 25; }
console.log(bet.profit)
var $cardList 	= $('.cardList').first(), 
    $cards 		= $('.card'),
    $speed 		= 5000, 
...
;*/
    ...
    spin(distance, 5000);
	  ...
	  if(caset == 'h') {
		  document.getElementById("value1").innerHTML = '1.3X'; //2
		  document.getElementById("value2").innerHTML = '10X'; //3
		  document.getElementById("value3").innerHTML = '0X'; //1
	...
	tags3[i].innerHTML = '10X';
		...
		'wager': wagerSatoshis,
		'payouts': [
    { "from": 0, "to": 425201762, "value": wagerSatoshis * 10.0 }, 
    { "from": 425201762, "to": 468151435, "value": wagerSatoshis * 0.3 },	
	{ "from": 468151435, "to": 4294967296, "value": wagerSatoshis * 0 }		
		]
      };
MoneyPot.placeCustomBet(params, {
        success: function(bet) {
		  ...
		  var result;
		  					  if(bet.profit == wagerSatoshis * 0.3 - wagerSatoshis) { result = 15; }
if(bet.profit == 0 - wagerSatoshis) { result = 20; }
if(bet.profit == wagerSatoshis * 10.0 - wagerSatoshis) { result = 25; }
console.log(bet.profit)
var $cardList 	= $('.cardList').first(), 
    $cards 		= $('.card'),
    $speed 		= 5000, 
...
;*/
    ...
    spin(distance, 5000);
	  ...
	  if(caset == 'vh') {
		  document.getElementById("value1").innerHTML = '1.3X'; //2
		  document.getElementById("value2").innerHTML = '100X'; //3
		  document.getElementById("value3").innerHTML = '0X'; //1
	...
	tags3[i].innerHTML = '100X';
		...
		'wager': wagerSatoshis,
		'payouts': [
    { "from": 0, "to": 42520176, "value": wagerSatoshis * 100.0 }, 
    { "from": 42520176, "to": 85469849, "value": wagerSatoshis * 0.3 },	
	{ "from": 85469849, "to": 4294967296, "value": wagerSatoshis * 0 }		
		]
      };
MoneyPot.placeCustomBet(params, {
        success: function(bet) {
		  ...
		  var result;
		  					  if(bet.profit == wagerSatoshis * 0.3 - wagerSatoshis) { result = 15; }
if(bet.profit == 0 - wagerSatoshis) { result = 20; }
if(bet.profit == wagerSatoshis * 100.0 - wagerSatoshis) { result = 25; }
console.log(bet.profit)
var $cardList 	= $('.cardList').first(), 
    $cards 		= $('.card'),
    $speed 		= 5000, 
